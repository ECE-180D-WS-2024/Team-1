...
BLEIntCharacteristic xAccelCharacteristic("663fdcf8-2126-464d-a6c1-c882f5477fb7", BLERead | BLEWrite);
BLEIntCharacteristic yAccelCharacteristic("e6ac0344-9aee-49ab-b601-1d26b77cf08c", BLERead | BLEWrite);
BLEIntCharacteristic zAccelCharacteristic("224ad21b-9c75-4e1c-a3f0-51c0c7d0a9a8", BLERead | BLEWrite);
BLEIntCharacteristic xAngularVeloCharacteristic("4de63bcd-e713-4e28-9392-3cc1d7efbabc", BLERead | BLEWrite);
BLEIntCharacteristic yAngularVeloCharacteristic("99c07d47-9018-489b-a937-0d911a61aa69", BLERead | BLEWrite);
BLEIntCharacteristic zAngularVeloCharacteristic("85c17e72-fb28-4883-9333-479b20fce5a7", BLERead | BLEWrite);
  ...
  if (central) {
    ...
    while (central.connected()) {
      ...
      if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable() && timer > 100) {
        ...
        Serial.print("ry: ");
        Serial.println(tx_ry);
        Serial.print("rz: ");
        Serial.println(tx_rz);
        xAccelCharacteristic.writeValue(tx_x);
        yAccelCharacteristic.writeValue(tx_y);
        zAccelCharacteristic.writeValue(tx_z);
        xAngularVeloCharacteristic.writeValue(tx_rx);
        yAngularVeloCharacteristic.writeValue(tx_ry);
        zAngularVeloCharacteristic.writeValue(tx_rz);
        prevUpdate = millis();
      }
    }
