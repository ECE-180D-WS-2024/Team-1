...
def generate_puzzle(app):
    ...
    for i, (btn_coord, init_pos_coord) in enumerate(BTN_INIT_POS_COORDS.items()):
        for btn_text in btn_texts:
            if btn_text.getName() == f'seq_btn{btn_coord[0]}{btn_coord[1]}':
                btn_text.setText(randomized_ordering[i])
